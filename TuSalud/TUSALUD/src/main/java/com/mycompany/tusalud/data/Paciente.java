...
public class Paciente extends Persona  {
   ...
   private List<Paciente> personasACargo = new ArrayList<>();
    ...
    public void setLugarDeAtencion(Lugar lugarDeAtencion) {
    ...
    public Lugar getLugarDeAtencion() {
    ...
    public String toString() {
        return super.toString() + "" + "Paciente{" + "historia_clinica=" + historia_clinica + ", lugarDeAtencion=" + lugarDeAtencion + ", cuenta=" + cuenta + ", observaciones=" + observaciones + ", personasACargo=" + personasACargo + '}';
    }
}
